        ...
        <div className="container">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to RentMe.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to RentMe, accessible from
                  <a
                    href="https://rentme.games"
            ...
            <p>
              ...
              go offline, while Session Cookies are deleted as soon as You
              close.
            </p>
            <p>
            ...
            <ul>
              <li>
                Leader's email:
                <span style={{ color: "red" }}> dinhhungGM@gmail.com</span>
              </li>
              <li>
                Member developer's email:
                <span style={{ color: "red" }}> khanglld1310@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
